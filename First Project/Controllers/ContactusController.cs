...
namespace First_Project.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Status,Ipaddress,Phonenumber")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Name,Email,Status,Ipaddress,Phonenumber")] Contactu contactu)
        {
            if (id != contactu.Id)
            {
                return NotFound();

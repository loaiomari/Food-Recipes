...
namespace First_Project.Controllers
{
    public class HomesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ImageOne,ImageTwo,ParagraphOne,ParagraphTwo")] Home home)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,ImageOne,ImageTwo,ParagraphOne,ParagraphTwo")] Home home)
        {
            if (id != home.Id)
            {
                return NotFound();

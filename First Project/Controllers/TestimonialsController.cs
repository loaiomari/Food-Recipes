...
namespace First_Project.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TestimonialId,Status,CreateDate,Message,Rating,UserId")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("TestimonialId,Status,CreateDate,Message,Rating,UserId")] Testimonial testimonial)
        {

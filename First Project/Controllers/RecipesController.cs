...
namespace First_Project.Controllers
{
    public class RecipesController : Controller
    {
        ...
        {
            var modelContext = _context.Recipes.Include(r => r.Cat);
        ...
        public async Task<IActionResult> Create([Bind("RecipeId,RecipeName,Sale,Price,CatId,CreateDate,Status,Ingredients")] Recipe recipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("RecipeId,RecipeName,Sale,Price,CatId,CreateDate,Status,Ingredients")] Recipe recipe)
        {
